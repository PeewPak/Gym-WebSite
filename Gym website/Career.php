...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="CSS/style_career.css">
...
<div id="registerBox" class="registerModal">
        ...
        <div class="job_offers">
            ...
            <h1 id="h1">Join our team</h1>
            <div class="speech">
                <h2 id="h2">If you are passionate about exercise and you would like to help others in their effort and I have no
                    fucking idea what to write next. Nie zesrajcie się wszyscy bo i tak zdechniemy.</h2>
            </div>

            <div class="job">
                <div class="title">
                    <h2>Poszukujemy kurwy z pasją</h2>
                </div>
                <div class="dis">
                ...
                <div class="butt"><Button class="apply">Apply</Button></div>
            </div>
